...
echo "SuperCowart canvas: http://127.0.0.1:${PORT}"
echo "SuperCowart canvas data: ${CANVAS_DIR}/pages/<page-id>/cowart-canvas.json"
echo "SuperCowart page assets: ${CANVAS_DIR}/pages/<page-id>/assets -> http://127.0.0.1:${PORT}/page-assets/<page-id>/"
